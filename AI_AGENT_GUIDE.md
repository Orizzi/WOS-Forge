...
- Fire Crystals now use ire_crystals_steps.json (generated by scripts/extract-fire-crystals-steps.js) with per-step time/resource costs; calculator sums steps between from/to.
