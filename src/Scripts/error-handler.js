(function(){
  ...
  function createNotification(type, title, message){
    try{
      ...
      container.style.padding = '0.75rem 0.875rem';
      container.style.borderRadius = '0.5rem';
      container.style.boxShadow = '0 0.25rem 0.75rem rgba(0,0,0,0.25)';
      ...
      close.style.lineHeight = '1.125rem';
  ...
  function renderCsvLoading(){
    ...
    if(!loadingBanner){
      ...
      loadingBanner.style.bottom = '1rem';
      loadingBanner.style.left = '1rem';
      loadingBanner.style.zIndex = '10000';
      loadingBanner.style.padding = '0.625rem 0.75rem';
      loadingBanner.style.borderRadius = '0.5rem';
      loadingBanner.style.display = 'flex';
      loadingBanner.style.alignItems = 'center';
      loadingBanner.style.gap = '0.5rem';
      ...
      loadingBanner.style.boxShadow = `0 0.25rem 0.875rem color-mix(in srgb, ${palette('info')} 35%, rgba(0,0,0,0.35))`;
