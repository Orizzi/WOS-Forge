...
(function () {
  ...
  const translations = {
    ...
    en: {
      ...
      'experts-header': 'Experts Calculator',
      'experts-config-title': 'Upgrade Plan',
      'experts-select': 'Expert',
      'experts-from': 'From level',
      'experts-to': 'To level',
      'experts-note': 'Data loads from experts_costs.csv with caching (24h).',
      'experts-results-title': 'Resources Needed',
      'experts-invalid-range': 'Select a valid range.',
      'experts-affinity': 'Affinity',
      'experts-sigils': 'Sigils',
      'experts-attack': 'Attack',
      'experts-bear-plus': 'Bear +',
      'experts-power': 'Power',
      'experts-skill': 'Skill',
      'experts-books': 'Books',
      'experts-xp': 'XP',
      'experts-skill-1': 'Skill 1',
      'experts-skill-2': 'Skill 2',
      'experts-skill-3': 'Skill 3',
      'experts-skill-4': 'Skill 4',
    ...
    es: {
      ...
      'experts-header': 'Calculadora de Expertos',
      'experts-config-title': 'Plan de mejora',
      'experts-select': 'Experto',
      'experts-from': 'Desde nivel',
      'experts-to': 'Hasta nivel',
      'experts-note': 'Los datos se cargan desde experts_costs.csv con caché (24h).',
      'experts-results-title': 'Recursos necesarios',
      'experts-invalid-range': 'Selecciona un rango válido.',
      'experts-affinity': 'Afinidad',
      'experts-sigils': 'Sigilos',
      'experts-attack': 'Ataque',
      'experts-bear-plus': 'Bear +',
      'experts-power': 'Poder',
      'experts-skill': 'Habilidad',
      'experts-books': 'Libros',
      'experts-xp': 'XP',
      'experts-skill-1': 'Habilidad 1',
      'experts-skill-2': 'Habilidad 2',
      'experts-skill-3': 'Habilidad 3',
      'experts-skill-4': 'Habilidad 4',
      'experts-affinity-progression': 'Progresión de Afinidad',
      'experts-sigil-unlocks': 'Desbloqueos de Sigilo de Nivel',
      'experts-summary': 'Recursos Totales',
      'experts-total-affinity': 'Afinidad Total',
      'experts-total-sigils': 'Sigilos Totales',
      'experts-total-power': 'Ganancia de Poder Total',
    ...
    ko: {
      ...
      'experts-header': '전문가 계산기',
      'experts-config-title': '업그레이드 계획',
      'experts-select': '전문가',
      'experts-from': '시작 레벨',
      'experts-to': '목표 레벨',
      'experts-note': 'experts_costs.csv에서 데이터를 불러오며 24시간 캐시합니다.',
      'experts-results-title': '필요 자원',
      'experts-invalid-range': '유효한 구간을 선택하세요.',
      'experts-affinity': '친밀도',
      'experts-sigils': '인장',
      'experts-attack': '공격',
      'experts-bear-plus': '곰 +',
      'experts-power': '전투력',
      ...
      'experts-books': '서적',
      'experts-xp': '경험치',
      'experts-skill-1': '스킬 1',
      'experts-skill-2': '스킬 2',
      'experts-skill-3': '스킬 3',
      'experts-skill-4': '스킬 4',
      'experts-affinity-progression': '친밀도 진행',
      'experts-sigil-unlocks': '인장 티어 잠금해제',
      'experts-summary': '필요한 총 자원',
      'experts-total-affinity': '총 친밀도',
      'experts-total-sigils': '총 인장',
      'experts-total-power': '총 전투력 증가',
    ...
    ru: {
      ...
      'experts-header': 'Калькулятор экспертов',
      'experts-config-title': 'План улучшения',
      'experts-select': 'Эксперт',
      'experts-from': 'С уровня',
      'experts-to': 'До уровня',
      'experts-note': 'Данные загружаются из experts_costs.csv с кешированием на 24ч.',
      'experts-results-title': 'Необходимые ресурсы',
      'experts-invalid-range': 'Выберите корректный диапазон.',
      'experts-affinity': 'Привязанность',
      'experts-sigils': 'Печати',
      'experts-attack': 'Атака',
      'experts-bear-plus': 'Bear +',
      'experts-power': 'Мощь',
      'experts-skill': 'Навык',
      'experts-books': 'Книги',
      'experts-xp': 'Опыт',
      'experts-skill-1': 'Навык 1',
      'experts-skill-2': 'Навык 2',
      'experts-skill-3': 'Навык 3',
      'experts-skill-4': 'Навык 4',
      'experts-affinity-progression': 'Развитие привязанности',
      'experts-sigil-unlocks': 'Разблокировка ярусов печатей',
      'experts-summary': 'Всего ресурсов',
      'experts-total-affinity': 'Всего привязанности',
      'experts-total-sigils': 'Всего печатей',
      'experts-total-power': 'Общее увеличение мощи',
    ...
    fr: {
      ...
      'experts-header': 'Calculateur d\'experts',
      'experts-config-title': 'Plan d\'amélioration',
      'experts-select': 'Expert',
      'experts-from': 'Depuis le niveau',
      'experts-to': 'Jusqu\'au niveau',
      'experts-note': 'Les données proviennent de experts_costs.csv avec cache (24h).',
      'experts-results-title': 'Ressources nécessaires',
      'experts-invalid-range': 'Sélectionnez une plage valide.',
      'experts-affinity': 'Affinité',
      'experts-sigils': 'Sceaux',
      'experts-attack': 'Attaque',
      'experts-bear-plus': 'Bear +',
      'experts-power': 'Puissance',
      'experts-skill': 'Compétence',
      'experts-books': 'Livres',
      'experts-xp': 'XP',
      'experts-skill-1': 'Compétence 1',
      'experts-skill-2': 'Compétence 2',
      'experts-skill-3': 'Compétence 3',
      'experts-skill-4': 'Compétence 4',
      'experts-affinity-progression': 'Progression de l\'affinité',
      'experts-sigil-unlocks': 'Déverrouillages de paliers de sceau',
      'experts-summary': 'Ressources totales',
      'experts-total-affinity': 'Affinité totale',
      'experts-total-sigils': 'Sceaux totaux',
      'experts-total-power': 'Gain de puissance total',
    ...
    de: {
      ...
      'experts-header': 'Experten-Rechner',
      'experts-config-title': 'Upgrade-Plan',
      'experts-select': 'Experte',
      'experts-from': 'Von Level',
      'experts-to': 'Bis Level',
      'experts-note': 'Daten aus experts_costs.csv mit 24h-Cache.',
      'experts-results-title': 'Benötigte Ressourcen',
      'experts-invalid-range': 'Gültigen Bereich wählen.',
      'experts-affinity': 'Bindung',
      'experts-sigils': 'Siegel',
      'experts-attack': 'Angriff',
      'experts-bear-plus': 'Bear +',
      'experts-power': 'Macht',
      'experts-skill': 'Fähigkeit',
      'experts-books': 'Bücher',
      'experts-xp': 'EP',
      'experts-skill-1': 'Fähigkeit 1',
      'experts-skill-2': 'Fähigkeit 2',
      'experts-skill-3': 'Fähigkeit 3',
      'experts-skill-4': 'Fähigkeit 4',
      'experts-affinity-progression': 'Bindungsfortschritt',
      'experts-sigil-unlocks': 'Siegel-Tier-Freischaltungen',
      'experts-summary': 'Gesamtressourcen',
      'experts-total-affinity': 'Gesamtbindung',
      'experts-total-sigils': 'Gesamtsiegel',
      'experts-total-power': 'Gesamtmachtzuwachs',
    ...
    pt: {
      ...
      'experts-header': 'Calculadora de Especialistas',
      'experts-config-title': 'Plano de upgrade',
      'experts-select': 'Especialista',
      'experts-from': 'Do nível',
      'experts-to': 'Até o nível',
      'experts-note': 'Dados carregados de experts_costs.csv com cache de 24h.',
      'experts-results-title': 'Recursos necessários',
      'experts-invalid-range': 'Selecione um intervalo válido.',
      'experts-affinity': 'Afinidade',
      'experts-sigils': 'Selos',
      'experts-attack': 'Ataque',
      'experts-bear-plus': 'Bear +',
      'experts-power': 'Poder',
      'experts-skill': 'Habilidade',
      'experts-books': 'Livros',
      'experts-xp': 'XP',
      'experts-skill-1': 'Habilidade 1',
      'experts-skill-2': 'Habilidade 2',
      'experts-skill-3': 'Habilidade 3',
      'experts-skill-4': 'Habilidade 4',
      'experts-affinity-progression': 'Progressão de Afinidade',
      'experts-sigil-unlocks': 'Desbloqueios de Nível de Sigilo',
      'experts-summary': 'Recursos Totais',
      'experts-total-affinity': 'Afinidade Total',
      'experts-total-sigils': 'Sigilos Totais',
      'experts-total-power': 'Ganho Total de Poder',
    ...
    it: {
      ...
      'experts-header': 'Calcolatore esperti',
      'experts-config-title': 'Piano di upgrade',
      'experts-select': 'Esperto',
      'experts-from': 'Dal livello',
      'experts-to': 'Al livello',
      'experts-note': 'Dati caricati da experts_costs.csv con cache (24h).',
      'experts-results-title': 'Risorse necessarie',
      'experts-invalid-range': 'Seleziona un intervallo valido.',
      'experts-affinity': 'Affinità',
      'experts-sigils': 'Sigilli',
      'experts-attack': 'Attacco',
      'experts-bear-plus': 'Bear +',
      'experts-power': 'Potenza',
      'experts-skill': 'Abilità',
      'experts-books': 'Libri',
      'experts-xp': 'XP',
      'experts-skill-1': 'Abilità 1',
      'experts-skill-2': 'Abilità 2',
      'experts-skill-3': 'Abilità 3',
      'experts-skill-4': 'Abilità 4',
      'experts-affinity-progression': 'Progressione affinità',
      'experts-sigil-unlocks': 'Sblocchi livello sigillo',
      'experts-summary': 'Risorse totali',
      'experts-total-affinity': 'Affinità totale',
      'experts-total-sigils': 'Sigilli totali',
      'experts-total-power': 'Guadagno di potenza totale',
  ...
  // Debug/dev functions defined above - removed duplicates to fix ESLint no-redeclare errors
